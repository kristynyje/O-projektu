    ...
    <>
      <div className="container">
        ...
        <p className="p_projekt">
          ...
          prihlášení přes Gmail, následovat bude formulář, ve kterém vyplní
          název aukce, popíše příběh, přidá fotografie předmětu i ty ve vztahu k
          danému příbehu, přidá vyvolávací cenu aj. a aukci založí. Odkazy na
          svou aukci může dále sdílet se svými přáteli, rodinou, známými či
          kolegy, dostanou se k ní pouze ti, kteří získali tento link.
        </p>
      </div>
    </>
  );
