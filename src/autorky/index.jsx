    ...
    <>
      <div className="container">
        ...
        <p className="p_autorky">
          ...
          čte a učí se nové věci. Její práci můžete sledovat třeba tady na
          <a href="https://github.com/Regi25"> Githubu</a>.
        </p>
        <p className="p_autorky">
          ...
          gluten-free dairy-free dobroty (jo a programuje, ofc, teď když to
          trochu umí). Její snažení můžete zkouknout zde na
          <a href="https://github.com/kristynyje"> Githubu</a>.
        </p>
      </div>
    </>
  );
